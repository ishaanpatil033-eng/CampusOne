  ...
  return (
    <div className="auth-card p-8 sm:p-10">
      <div className="mb-8">
        ...
        <p className="text-slate-500 mt-1">Sign in to your CampusOne account</p>
      </div>
      ...
      <p className="text-center text-sm text-slate-500 mt-6">
        ...
        <Link to="/register" id="register-link" className="text-primary-600 hover:text-primary-700 font-semibold">
          Create one
        </Link>
      </p>
    </div>
